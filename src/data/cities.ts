...
Our mobile service is simple: book online, and we arrive at your door with our full sharpening setup. We work through your knives on-site — at 2 to 4 minutes a blade, a typical visit runs roughly 15 to 30 minutes in North Burnaby and 20 to 40 in South Burnaby. Restoration, broken tips and chip repairs take longer. We handle every type of blade: German, Japanese, ceramic, serrated, cleavers, scissors, and even garden shears. Each knife is inspected for damage, sharpened to its correct angle, and tested before we hand it back. Our 30-day edge guarantee means if you are not satisfied, we re-sharpen at no cost.`,
    neighbourhoods: [
...
We sharpen every type of blade on-site: German chef's knives from Wusthof and Henckels, Japanese gyutos and santokus, single-bevel yanagibas and debas, ceramic, serrated bread knives, cleavers, scissors, and garden shears. Each blade is inspected for chips or damage before sharpening, ground to the original factory angle, then tested before we hand it back. At 2 to 4 minutes a blade, a typical 15-piece Coquitlam visit runs roughly 30 to 60 minutes start to finish. Restoration, broken tips and chip repairs take longer. Every sharpening is backed by our 30-day edge guarantee. For Coquitlam customers who would prefer drop-off, our 24/7 box at 4086 Brockton Crescent in North Vancouver has no minimum and a 24–48 hour turnaround.`,
    neighbourhoods: [
...
Our mobile service is built for households exactly like the ones in PoCo. Book online, pick a time that suits, and we drive to your address with the full professional sharpening rig in the back of the van. At 2 to 4 minutes a blade, a 15-piece visit takes roughly 30 to 60 minutes — restoration, broken tips and chip repairs take longer — and we work through everything on the spot — no drop-off, no shipping, no waiting days for your knives to come back. We handle German blades, Japanese single-bevel and double-bevel, ceramic, serrated, cleavers, scissors, and outdoor knives. Every sharpening comes with our 30-day edge guarantee.`,
    neighbourhoods: [
...
We sharpen every type of knife on-site: German chef's knives from Wusthof and Henckels, Japanese gyutos and santokus, single-bevel yanagibas and debas, ceramic blades, serrated bread knives, cleavers, paring knives, and scissors. Each blade is inspected for chips or damage before we start, sharpened to its correct factory angle, then tested before we hand it back. We use Japanese waterstones for the precision work and professional belt systems for efficient bulk sharpening — the same approach we use for restaurant accounts across the region. Every job is backed by our 30-day edge guarantee.`,
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Roughly 30 to 60 minutes for a typical 15-piece visit — we work at 2 to 4 minutes a blade, though restoration, broken tips and chip repairs take longer. We set up on a clean surface in your kitchen or garage, work through the blades one by one, and pack up. You can keep cooking, working, or watching the process — whichever you prefer.',
      },
      {
...
Each blade is inspected for damage, sharpened to its original factory angle using Japanese waterstones or precision belt systems as appropriate, and tested before we hand it back. At 2 to 4 minutes a blade, a 15-piece visit takes roughly 30 to 60 minutes, start to finish on-site at your address. Restoration, broken tips and chip repairs take longer. We back every sharpening with our 30-day edge guarantee — if the edge does not hold under normal use, we re-sharpen at no cost. For Surrey customers who would prefer not to wait for a mobile appointment, the 24/7 drop-off box at 4086 Brockton Crescent in North Vancouver is about a 40-minute drive with no minimum order.`,
    neighbourhoods: [
