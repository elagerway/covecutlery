...
Our mobile service is simple: book online, and we arrive at your door with our full sharpening setup. We work through your knives on-site — at roughly 5 minutes a blade, a typical visit runs about 40 minutes in North Burnaby and 50 in South Burnaby. We handle every type of blade: German, Japanese, ceramic, serrated, cleavers, scissors, and even garden shears. Each knife is inspected for damage, sharpened to its correct angle, and tested before we hand it back. Our 30-day edge guarantee means if you are not satisfied, we re-sharpen at no cost.`,
    neighbourhoods: [
...
Our mobile service is built for households exactly like the ones in PoCo. Book online, pick a time that suits, and we drive to your address with the full professional sharpening rig in the back of the van. At roughly 5 minutes a blade, a 15-piece visit takes about an hour and a quarter, and we work through everything on the spot — no drop-off, no shipping, no waiting days for your knives to come back. We handle German blades, Japanese single-bevel and double-bevel, ceramic, serrated, cleavers, scissors, and outdoor knives. Every sharpening comes with our 30-day edge guarantee.`,
    neighbourhoods: [
...
We sharpen every type of knife on-site: German chef's knives from Wusthof and Henckels, Japanese gyutos and santokus, single-bevel yanagibas and debas, ceramic blades, serrated bread knives, cleavers, paring knives, and scissors. Each blade is inspected for chips or damage before we start, sharpened to its correct factory angle, then tested before we hand it back. We use Japanese waterstones for the precision work and professional belt systems for efficient bulk sharpening — the same approach we use for restaurant accounts across the region. Every job is backed by our 30-day edge guarantee.`,
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'About an hour and a quarter for a typical 15-piece visit — we work at roughly 5 minutes a blade. We set up on a clean surface in your kitchen or garage, work through the blades one by one, and pack up. You can keep cooking, working, or watching the process — whichever you prefer.',
      },
      {
